...
type Theme struct {
	*material.Theme
	...
	TableSelectedBg       color.NRGBA
	TableEvenRowBg        color.NRGBA
}

func New(m *material.Theme, isDark bool) *Theme {
	t := &Theme{
		Theme: m,
	}
...
func (t *Theme) Switch(isDark bool) *material.Theme {
	...
	if isDark {
		...
		t.SecondaryTextColor = rgb(0x8b8e95)
		t.TableSelectedBg = rgb(0x35373a)
		t.TableEvenRowBg = rgb(0x25272a)
	} else {
		...
		t.SecondaryTextColor = rgb(0x6c6f76)
		t.TableSelectedBg = rgb(0xeef0f2)
		t.TableEvenRowBg = rgb(0xf9fafb)
	}
